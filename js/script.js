const ApiKey = "4370be1bd0ed4b0aac269ec0aebddfc5";
...
function showTeamInfo(page){
    ...
    <div class="col s12 center-align">
      <div class="card">
        <div class=resJson.crestUrl>
          <img src="${resJson.crestUrl}">
         
        </div>
        <div class="card-content">
        <span class="INFO TIM">INFO TIM</span>
          <p> NAMA TIM : ${resJson.name} <br>
              MARKAS   : ${resJson.venue} <br>
              TAHUN BERDIRI : ${resJson.founded} <br>
              EMAIL : ${resJson.email} <br>
              WARNA : ${resJson.clubColors} <br>
              TELEPON   : ${resJson.phone} <br>
